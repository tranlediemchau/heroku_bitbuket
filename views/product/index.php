...
<div class="top_bg">
    <div class="wrap">
        <div class="main_top">
            <h2 class="style">Sản phẩm cuẩ shop</h2>
        </div>
    </div>
</div>
<!-- start main -->
                ...
                else
                {
                    foreach($this->data['lstProduct'] as $row){ ?>
                        <div class="grid1_of_3">
                            <a href="<?php __SITE_PATH ?>/product/detail/<?php echo $row['id'] ?>">
                                <img src="<?php __SITE_PATH ?>/public/images/<?php echo $row['images_url'] ?>" alt=""/>
                                <h3><?php  echo $row['name']?></h3>
                                <span class="price"><?php echo $row['price1']?></span>
                            </a>
                        </div>
