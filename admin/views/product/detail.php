            ...
            <div class="single">
                ...
                <div class="left_sidebar">
                    ...
                    <!--<div class="left_products">
                        <?php  while ($row = mysql_fetch_assoc($lstProductNew)){?>
                            <div class="left_img">
                                <img src="./images/<?php echo $row['images_url'];?>" alt="<?php echo $row['name'] ;?> "/>
                            </div>
                            <div class="left_text">
                                <p><a href="index.php?page=detail&id=<?php echo $row['id'];?>"><?php echo $row['name']; ?></a></p>
                                <span class="line"><?php echo $row['price2'] ?></span>
                                <span><?php echo $row['price1'] ?></span>
                            </div>
                            <div class="clear"></div>
                        <?php }?>
                    </div>-->
