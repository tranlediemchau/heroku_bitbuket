            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <form action ="<?php __SITE_PATH?>/admin/product/insert" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="textbox" name="txtSoLuong" class="form-control" id="exampleInputPassword1" placeholder="Số lượng ">
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Mô tả</label>
                                    <textarea placeholder="Mô tả"  name="txtMoTa" class="form-control" id="exampleInputFile"></textarea>
