                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <?php
                            if(!isset($this->data['lstAccount']))
                            {
                                echo 'không có tài khoản nào';
                            }
                            else
                            {
                                foreach($this->data['lstAccount'] as $row){ ?>
                                <tr>
                                    <a href="#">
                                        ...
                                        <td>
                                            <a href='<?php echo  __SITE_PATH ?>admin/user/edit/<?php echo $row['id'];?>'>Edit</a>
                                            <a href="<?php echo  __SITE_PATH ?>admin/user/delete/<?php echo $row['id'];?>" onclick=" return show_alert();">Delete</a>
                                        </td>
                                        <td>
